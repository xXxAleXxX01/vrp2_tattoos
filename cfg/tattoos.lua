...
-- _config: blip_id, blip_color, permissions (optional, only users with the permission will have access to the shop)
-- https://wiki.gtanet.work/index.php?title=Blips
-- https://wiki.fivem.net/wiki/Controls

cfg.tattoos = {
	["mpbeach_overlays"] = { -- native store name
		_config = {map_entity = {"PoI", {blip_id=75,blip_color=48,title="Beach Tattoos", marker_id = 1}}}, -- you can add permissions like on other vRP features
	...
	["mpbusiness_overlays"] = {
		_config = {map_entity = {"PoI", {blip_id=75,blip_color=48,title="Business Tattoos", marker_id = 1}}},
		["CLEAR"] = {">Clear Tattoos",500,""},
	...
	["mphipster_overlays"] = {
		_config = {map_entity = {"PoI", {blip_id=75,blip_color=48,title="Hipster Tattoos", marker_id = 1}}},
		["CLEAR"] = {">Clear Tattoos",500,""},
